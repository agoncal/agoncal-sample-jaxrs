...
import org.agoncal.sample.jaxrs.qbe.provider.model.Books;
import org.agoncal.sample.jaxrs.qbe.provider.model.Language;
...
public class BookEndpointIT {
    ...
    private static final String URL = "http://localhost:8080/sampleJaxRsQBEProvider/rest";
